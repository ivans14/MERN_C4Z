...
import Get_DB_data from './get_DB_data';
...
const headCells2: readonly HeadCell2[] = [
  {
    id: 'Description',
    numeric: false,
    disablePadding: true,
...
export default function EnhancedTable() {
  ...
  const [visibleRows2, setVisibleRows2] = React.useState<Idea[] | null>(null);
  ...
  React.useEffect(() => {
    Get_DB_data().then((data) => {
      console.log(data);
      let rows_onmount: Idea[] = data;
      console.log(rows_onmount[0].Department);
      setVisibleRows2(rows_onmount);
